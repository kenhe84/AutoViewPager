...
public class AnimIndicator extends LinearLayout implements PageIndicator {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.AnimIndicator);
            mIndicatorWidth = typedArray.getDimensionPixelSize(R.styleable.AnimIndicator_ci_width, -1);
            mIndicatorHeight = typedArray.getDimensionPixelSize(R.styleable.AnimIndicator_ci_height, -1);
            mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.AnimIndicator_ci_margin, -1);
