...
public class CircleIndicator extends View implements PageIndicator {
    ...
    public CircleIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultFillColor = res.getColor(R.color.default_373737);
        ...
        mPaintStroke.setStyle(Style.FILL);//背景实心圆
//        mPaintStroke.setStyle(Style.STROKE);//背景空心圆
...
//            longOffset += ((longSize - longPaddingBefore - longPaddingAfter) / 2.0f) - ((mRealCount * threeRadius) / 2.0f);
        ...
        for (int iLoop = 0; iLoop < count; iLoop++) {
            ...
            if (pageFillRadius != mRadius) {
                canvas.drawCircle(dX, dY, mRadius/2, mPaintStroke);
            }
        }
