...
public class InfiniteIndicatorLayout extends RelativeLayout implements RecyclingPagerAdapter.DataChangeListener {
	...
	public InfiniteIndicatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		int indicatorType = attributes.getInt(R.styleable.InfiniteIndicatorLayout_indicator_type,
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		if (ev.getAction() == MotionEvent.ACTION_DOWN) {
			if(mViewPagerActionDownListener!=null){
				mViewPagerActionDownListener.viewPagerActionDown(ev.getY());
			}
		}
	...
	public ViewPagerActionDownListener mViewPagerActionDownListener=null;
	/** viewpager坐标Y*/
	public void setViewPagerActionDownListener(ViewPagerActionDownListener viewPagerActionDownListener) {
		mViewPagerActionDownListener = viewPagerActionDownListener;
	}
	/** 点下.viewpager坐标*/
	public interface ViewPagerActionDownListener {
	...
	public void setCustomIndicator(PageIndicator indicator) {
		...
		CircleIndicator circleIndicator =(CircleIndicator)mIndicator;
		android.view.ViewGroup.LayoutParams lp = circleIndicator.getLayoutParams();
		switch (count) {
		case 1:
			lp.width=DisplayUtil.sp2px(mContext, 15);
			break;
		case 2:
			lp.width=DisplayUtil.sp2px(mContext, 30);		
			break;
		case 3:
			lp.width=DisplayUtil.sp2px(mContext, 50);
			break;
		case 4:
			lp.width=DisplayUtil.sp2px(mContext, 60);
			break;
		case 5:
			lp.width=DisplayUtil.sp2px(mContext, 75);
			break;
		case 6:
			lp.width=DisplayUtil.sp2px(mContext, 90);
			break;
		case 7:
			lp.width=DisplayUtil.sp2px(mContext, 110);
			break;
		case 8:
			lp.width=DisplayUtil.sp2px(mContext, 125);
			break;
		case 9:
			lp.width=DisplayUtil.sp2px(mContext, 135);
			break;
		case 10:
			lp.width=DisplayUtil.sp2px(mContext, 155);
			break;
		}
